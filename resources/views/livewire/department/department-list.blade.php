<div class="py-6">
    ...
    <div class="bg-white p-6 dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-200">
       <div class="pb-4 w-64">
            <x-input placeholder="Search department..." />
        </div>
